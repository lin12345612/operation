...
$(function(){
//            给表情对应的a标签创建一个div
    var $faceDiv=$("<div class='showFace'></div>")
    for(var k in userFaces){
        var $imgs = $("<img src='faces/"+ k+"' alt='"+userFaces[k]+"'>");
        $faceDiv.append($imgs);
    }
    $(".insertFace").append($faceDiv)
                    .on({
                        "mouseenter":function(){
