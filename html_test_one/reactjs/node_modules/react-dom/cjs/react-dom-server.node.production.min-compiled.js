...
function za(a, b) {
  for (; r.isValidElement(a);) {
    ...
    } else h = null;a = d.render();ya(a, c);if ("function" === typeof d.getChildContext && (g = c.childContextTypes, "object" === (typeof g === "undefined" ? "undefined" : _typeof(g)))) {
...
var Y = function () {
  function a(b, g) {
    ...
    }if (e = f) na[b] && (null != e.children || null != e.dangerouslySetInnerHTML ? w("137", b, pa()) : void 0), null != e.dangerouslySetInnerHTML && (null != e.children ? w("60") : void 0, "object" === _typeof(e.dangerouslySetInnerHTML) && "__html" in e.dangerouslySetInnerHTML ? void 0 : w("61")), null != e.style && "object" !== _typeof(e.style) ? w("62", pa()) : void 0;e = f;d = this.makeStaticMarkup;n = 1 === this.stack.length;p = "\x3c" + a.type;for (q in e) {
...
var Ba = function (a) {
  function b(g, c) {
    if (!(this instanceof b)) throw new TypeError("Cannot call a class as a function");var h = a.call(this, {});if (!this) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");h = !h || "object" !== (typeof h === "undefined" ? "undefined" : _typeof(h)) && "function" !== typeof h ? this : h;h.partialRenderer = new Y(g, c);return h;
...
//# sourceMappingURL=react-dom-server.node.production.min-compiled.js.map