...
exports['General tests'] = {
    ...
    'Iconv is available': function IconvIsAvailable(test) {
        test.ok(Iconv);
        test.done();
    },

    'From UTF-8 to Latin_1 with Iconv': function FromUTF8ToLatin_1WithIconv(test) {
        var input = 'ÕÄÖÜ',
    ...
    'From Latin_1 to UTF-8 with Iconv': function FromLatin_1ToUTF8WithIconv(test) {
    ...
    'From UTF-8 to UTF-8 with Iconv': function FromUTF8ToUTF8WithIconv(test) {
        var input = 'ÕÄÖÜ',
    ...
    'From Latin_13 to Latin_15 with Iconv': function FromLatin_13ToLatin_15WithIconv(test) {
    ...
    'From ISO-2022-JP to UTF-8 with Iconv': function FromISO2022JPToUTF8WithIconv(test) {
    ...
    'From UTF-8 to Latin_1 with iconv-lite': function FromUTF8ToLatin_1WithIconvLite(test) {
        var input = 'ÕÄÖÜ',
            expected = new Buffer([0xd5, 0xc4, 0xd6, 0xdc]);
    ...
    'From Latin_1 to UTF-8 with iconv-lite': function FromLatin_1ToUTF8WithIconvLite(test) {
        var input = new Buffer([0xd5, 0xc4, 0xd6, 0xdc]),
            expected = 'ÕÄÖÜ';
    ...
    'From UTF-8 to UTF-8 with iconv-lite': function FromUTF8ToUTF8WithIconvLite(test) {
        var input = 'ÕÄÖÜ',
            expected = new Buffer('ÕÄÖÜ');
    ...
    'From Latin_13 to Latin_15 with iconv-lite': function FromLatin_13ToLatin_15WithIconvLite(test) {
        var input = new Buffer([0xd5, 0xc4, 0xd6, 0xdc, 0xd0]),
            expected = new Buffer([0xd5, 0xc4, 0xd6, 0xdc, 0xA6]);
