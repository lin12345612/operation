  ...
  */
  ...
  function createElementWithValidation(type, props, children) {
    ...
    if (!validType) {
      ...
      warning_1(false, 'React.createElement: type is invalid -- expected a string (for ' + 'built-in components) or a class/function (for composite ' + 'components) but got: %s.%s', type == null ? type : typeof type === 'undefined' ? 'undefined' : _typeof(type), info);
    }
...
//# sourceMappingURL=react.development-compiled.js.map